            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <img className="h-12 w-auto" src="/assets/images/logo.png" alt="" />
                    </a>
                </div>
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    <Popover>
                        ...
                        >
                            <Popover.Panel className="absolute inset-x-0 top-0 -z-10 gray-900 pt-14 shadow-lg ring-1 ring-gray-900/5">
                                <div className="mx-auto grid max-w-7xl grid-cols-4 gap-x-4 px-6 py-10 lg:px-8 xl:gap-x-8">
                                    {products.map((item) => (
                                        <div key={item.name} className="group relative rounded-lg p-6 text-sm leading-6 hover:bg-gray-50">
                                            ...
                                            <a href={item.href} className="mt-6 block font-semibold text-white">
                                                {item.name}
